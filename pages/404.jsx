...
const aea = () => {
    return (
        ...
        <div style={{
            ...
            <div>
                <style>body </style>
                <h1 style={{ display: 'inline - block', borderRight: '1px1 solid rgba(0, 0, 0,.3)', margin: '0', padding: '10px 23px 10px 0', fontSize: '24px', fontWeight: '500', verticalAlign: 'top' }}>404</h1>
                <div style={{ display: 'inline - block', textAlign: 'left', lineHeight: '49px', height: '9px', verticalAlign: 'middle' }}>
                    <h2 style={{ fontSize: '14px', fontWeight: 'normal', lineHeight: 'inherit', margin: '0', padding: '0' }}>
                      <Icon name="warning sign"/>  Opps! hubo un error</h2>
                </div >
